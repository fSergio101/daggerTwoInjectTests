...
import com.gigigo.daggertwoinjecttests.presenters.PresenterInject;
 ...
 * Date 27/5/16.
 */
@TargetApi(Build.VERSION_CODES.HONEYCOMB) public class FragmentInject extends Fragment {

  private View view;
  @Inject PresenterInject presenterInject;
  ...
  @Override public void onStart() {
    ...
    tv.setText(presenterInject.printSomething());
  }
