 ...
 * Date 27/5/16.
 */
@TargetApi(Build.VERSION_CODES.HONEYCOMB) public class FragmentProvidesFail extends Fragment{

  @Inject PresenterProvidesFail presenterProvidesFail;
  private View view;
  ...
  @Override public void onStart() {
    ...
    tv.setText(presenterProvidesFail.printSomething());
  }
